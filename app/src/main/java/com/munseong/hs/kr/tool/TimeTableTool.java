...
public class TimeTableTool {
    public static final String TimeTableDBName = "MsHighSchoolTimeTable.db";
    public static final String tableName = "MsTimeTable";

    //    public final static String mFilePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/MunseongHS/";
    public final static String mFilePath = "/data/data/com.munseong.hs.kr/databases/";
    public final static String mGoogleSpreadSheetUrl = "https://docs.google.com/spreadsheets/d/1Lmy-hWcEHueczSPQ0ypmAizVLpkrMf-9zG3wXv6epjA/pubhtml";
