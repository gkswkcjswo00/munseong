package com.munseong.hs.kr.activity.exam;
...
import com.munseong.hs.kr.tool.ExamTimeTool;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((mGrade != -1) && (mType != -1)) {
            if (fileExists) {
                ...
                mToolbar.setTitle(String.format(getString(R.string.exam_time_title), mGrade, (mType == 0 ? "이과" : "문과"), mData.date, mData.type));
            }
        }
