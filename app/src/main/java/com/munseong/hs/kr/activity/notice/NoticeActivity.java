package com.munseong.hs.kr.activity.notice;
...
import com.munseong.hs.kr.activity.settings.SettingsActivity;
import com.munseong.hs.kr.tool.Database;
...
public class NoticeActivity extends AppCompatActivity {
    ...
    private void showNoticeData(boolean forceUpdate) {
        ...
        if (Tools.isOnline(getApplicationContext())) {
            if (Tools.isWifi(getApplicationContext()) || forceUpdate) {
                ...
                mTask.execute("https://docs.google.com/spreadsheets/d/1IGqYLGW6Ql8q9fVRCh76uy6lwqGAb7y3Xx9k8oHeAUE/pubhtml");
            } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_show_notice) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AppCompatAlertDialogStyle);
            builder.setTitle(R.string.student_into_title);
            builder.setMessage(R.string.student_into_msg);
            builder.setPositiveButton(android.R.string.ok, null);
            builder.show();
        }
